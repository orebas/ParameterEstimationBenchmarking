...
p_rand = rand(Uniform(0.0, 100.0), length(ic) + length(p_true)) # Random Parameters
...
optprob = Optimization.OptimizationProblem(optf, p_rand, lb = 0.0*ones(5+3), ub = 100.0*ones(5+3))
