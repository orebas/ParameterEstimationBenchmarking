...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-29-10-07/copy_1em6/data/vanderpol_1.csv", Tuple, header=false))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-29-10-07/copy_1em6/estimation_results/vanderpol_1.csv", table, header=string.(collect(keys(table))))
