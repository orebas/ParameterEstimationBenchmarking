...
p_true = [0.805, 0.654, 0.68, 0.501, 0.865, 0.615, 0.439, 0.585, 0.115, 0.341, 0.628, 0.332, 0.594]
ic = [0.443, 0.208, 0.339, 0.556, 0.573]
...
write(joinpath(@__DIR__, "../data_original/crauste_1.csv"), dat_str)
