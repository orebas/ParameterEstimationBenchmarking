...
ic = [0.571, 0.765, 0.603, 0.798, 0.319]
p_true = [0.529, 0.817, 0.892, 0.274, 0.63, 0.311, 0.117, 0.707, 0.356, 0.407]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_1em4/data/hiv_2.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_1em4/estimation_results/hiv_2.csv", table, header=string.(collect(keys(table))))
