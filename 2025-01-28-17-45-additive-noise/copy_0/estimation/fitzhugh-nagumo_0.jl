...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-28-17-45/copy_0/data/fitzhugh-nagumo_0.csv", Tuple, header=false))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-28-17-45/copy_0/estimation_results/fitzhugh-nagumo_0.csv", table, header=string.(collect(keys(table))))
