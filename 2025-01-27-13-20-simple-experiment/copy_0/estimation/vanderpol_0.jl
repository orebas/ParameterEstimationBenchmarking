...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-13-20/copy_0/data/vanderpol_0.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-13-20/copy_0/estimation_results/vanderpol_0.csv", table, header=string.(collect(keys(table))))
