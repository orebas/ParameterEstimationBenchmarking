...
state_equations = [
    D(x1) ~ (-0.1*k01*x1 + 0.4*k12*x2 + 0.8999999999999999*k13*x3 + 1.6*k14*x4 - 0.5*k21*x1 - 0.6000000000000001*k31*x1 - 0.7000000000000001*k41*x1) / 0.4,
...
ic = [0.323, 0.268, 0.193, 0.562]
p_true = [0.524, 0.838, 0.172, 0.425, 0.119, 0.374, 0.598]
