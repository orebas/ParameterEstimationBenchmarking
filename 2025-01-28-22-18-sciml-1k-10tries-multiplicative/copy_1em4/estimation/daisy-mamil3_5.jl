...
ic = [0.827, 0.752, 0.228]
p_true = [0.786, 0.466, 0.861, 0.561, 0.757]
time_interval = [-1.0, 1.0]
datasize = 1001

sampling_times = range(time_interval[1], time_interval[2], length = datasize)

data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-28-22-18/copy_1em4/data/daisy-mamil3_5.csv", Tuple, header=false))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-28-22-18/copy_1em4/estimation_results/daisy-mamil3_5.csv", table, header=string.(collect(keys(table))))
