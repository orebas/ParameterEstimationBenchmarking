...
p_constraints = Dict((muN=>(, )), (muEE=>(, )), (muLE=>(, )), (muLL=>(, )), (muM=>(, )), (muP=>(, )), (muPE=>(, )), (muPL=>(, )), (deltaNE=>(, )), (deltaEL=>(, )), (deltaLM=>(, )), (rhoE=>(, )), (rhoP=>(, )))
ic_constraints = Dict((n=>(, )), (e=>(, )), (s=>(, )), (m=>(, )), (p=>(, )))
 
time_interval = [-1.0, 1.0]
datasize = 201

data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-03-40/copy_1em2/data/crauste_1.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-03-40/copy_1em2/estimation_results/crauste_1.csv", table, header=string.(collect(keys(table))))
