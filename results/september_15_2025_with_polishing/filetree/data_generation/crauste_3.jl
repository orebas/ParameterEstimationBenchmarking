...
p_true = [0.199, 0.778, 0.746, 0.555, 0.426, 0.155, 0.658, 0.463, 0.678, 0.793, 0.88, 0.785, 0.109]
ic = [0.388, 0.684, 0.237, 0.517, 0.143]
...
write(joinpath(@__DIR__, "../data_original/crauste_3.csv"), dat_str)
