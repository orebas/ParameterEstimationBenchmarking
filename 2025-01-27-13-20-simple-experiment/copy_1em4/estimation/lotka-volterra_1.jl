...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-13-20/copy_1em4/data/lotka-volterra_1.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-13-20/copy_1em4/estimation_results/lotka-volterra_1.csv", table, header=string.(collect(keys(table))))
