...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-03-53/copy_1em4/data/crauste_1.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-03-53/copy_1em4/estimation_results/crauste_1.csv", table, header=string.(collect(keys(table))))
