...
ic = [0.233, 0.838]
p_true = [0.641, 0.296, 0.273]
time_interval = [-1.0, 1.0]
datasize = 1001

sampling_times = range(time_interval[1], time_interval[2], length = datasize)

data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-28-22-18/copy_1em4/data/lotka-volterra_0.csv", Tuple, header=false))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-28-22-18/copy_1em4/estimation_results/lotka-volterra_0.csv", table, header=string.(collect(keys(table))))
