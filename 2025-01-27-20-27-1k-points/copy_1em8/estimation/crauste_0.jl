...
ic = [0.182, 0.267, 0.229, 0.622, 0.303]
p_true = [0.388, 0.45, 0.658, 0.148, 0.633, 0.637, 0.268, 0.203, 0.352, 0.391, 0.556, 0.451, 0.891]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_1em8/data/crauste_0.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_1em8/estimation_results/crauste_0.csv", table, header=string.(collect(keys(table))))
