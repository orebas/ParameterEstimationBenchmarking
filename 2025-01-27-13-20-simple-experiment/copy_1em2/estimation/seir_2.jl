...
ic = [0.167, 0.542, 0.568, 0.87]
p_true = [0.712, 0.699, 0.823]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-13-20/copy_1em2/data/seir_2.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-13-20/copy_1em2/estimation_results/seir_2.csv", table, header=string.(collect(keys(table))))
