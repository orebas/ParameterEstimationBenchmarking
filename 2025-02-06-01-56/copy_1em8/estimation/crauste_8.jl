...
ic = [0.546, 0.788, 0.682, 0.316, 0.205]
p_true = [0.426, 0.286, 0.206, 0.143, 0.68, 0.109, 0.716, 0.218, 0.164, 0.172, 0.638, 0.296, 0.436]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em8/data/crauste_8.csv", Tuple, header=false))
...
CSV.write("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em8/estimation_results/crauste_8.csv", table, header=string.(collect(keys(table))))
