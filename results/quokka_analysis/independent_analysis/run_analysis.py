#!/usr/bin/env python3
"""
Independent Benchmark Analysis for benchmark_quokka_2026_03_05
Produces 8 CSV tables, 14 PNG figures, and a REPORT.md summary.

All rankings and conclusions are data-driven (not hardcoded).

Usage:
    python3 results/quokka_analysis/independent_analysis/run_analysis.py
"""
...
def generate_report(df, t01, t02, t03, t05):
    ...
    # Build data-driven executive summary
    ...
    fastest_method = min(METHOD_ORDER, key=lambda m: timing[METHOD_LABELS[m]])
    fastest_label = METHOD_LABELS[fastest_method]
    slowest_method = max(METHOD_ORDER, key=lambda m: timing[METHOD_LABELS[m]])
    slowest_label = METHOD_LABELS[slowest_method]

    report = f"""# Independent Benchmark Analysis Report
## benchmark_quokka_2026_03_05
