...
p_constraints = Dict((k5=>(0.0, 10.0)), (k6=>(0.0, 10.0)), (k7=>(0.0, 10.0)), (k8=>(0.0, 10.0)), (k9=>(0.0, 10.0)), (k10=>(0.0, 10.0)))
ic_constraints = Dict((x4=>(0.0, 10.0)), (x5=>(0.0, 10.0)), (x6=>(0.0, 10.0)), (x7=>(0.0, 10.0)))
