#!/usr/bin/env python3
"""
Generate a self-contained reveal.js HTML presentation from the benchmark analysis.
All images are embedded as base64 — the output is a single portable HTML file.
Reveal.js is also inlined so the file works fully offline.
...
def fetch_url(url):
    """Fetch URL content as string, with fallback to CDN link."""
    try:
...
def build_presentation():
    # Fetch reveal.js assets for offline embedding
    ...
    domain_map = {
        ...
        "two_compartment_pk": "Pharmacology", "vanderpol": "Mechanical",
    }
    from collections import Counter
    domain_counts = Counter(domain_map.values())

    # Polishing per-noise summary
    polish_by_noise = []
    ...
    <p style="font-size:0.8em; color:#95a5a6;">benchmark_wombat_2026_02_26</p>
    ...
    <div class="columns">
        <div class="col">
            <h3>Scope</h3>
            <ul>
                <li><strong>{n_systems}</strong> ODE systems from 7 domains</li>
    ...
    <div class="columns">
        ...
        <div class="col" style="flex:2;">
            ...
            <ul>
                <li>Identifiable parameters: <strong>1 &ndash; 17</strong></li>
                <li>Non-identifiable parameters: <strong>0 &ndash; 4</strong></li>
                <li>State variables: <strong>2 &ndash; 6</strong></li>
    ...
    <div class="key-findings">
        <div class="finding">
            <div class="finding-number">{m_succ['amigo2_run']:.1f}%</div>
            <div class="finding-label">AMIGO2 overall success@10%<br><small>Highest of all methods</small></div>
        </div>
        <div class="finding">
    ...
    <div class="takeaway">
        <strong>Key:</strong> AMIGO2 leads in accuracy but is slower.
        SciML is fast but has the lowest success rate.
    </div>
    """)
    ...
    {img_tag("F01", "80%")}
    <p class="caption">All methods degrade with noise. AMIGO2 maintains the flattest curve.</p>
    """)
    ...
    <table class="data-table ranking-table">
        ...
        <tr class="rank-1"><td>1</td><td>AMIGO2</td><td>{m_succ['amigo2_run']:.1f}%</td>
            <td>Highest accuracy, noise-robust</td><td>Slowest, requires MATLAB</td></tr>
        <tr class="rank-2"><td>2</td><td>ODEPE (polish)</td><td>{m_succ['odepe_polish']:.1f}%</td>
            <td>Best speed-accuracy balance</td><td>Polishing adds time</td></tr>
        <tr class="rank-3"><td>3</td><td>ODEPE (no polish)</td><td>{m_succ['odepe_nopolish']:.1f}%</td>
            <td>Fast, good baseline</td><td>Degrades at high noise</td></tr>
        <tr class="rank-4"><td>4</td><td>SciML</td><td>{m_succ['sciml_run']:.1f}%</td>
            <td>Fastest method</td><td>Lowest accuracy, most failures</td></tr>
    </table>
    """, bg="#1a1a2e")
    ...
    <div class="takeaway-grid">
        ...
        <div class="takeaway-card">
            ...
            <p>AMIGO2 wins most often but specific systems favor other methods.</p>
        </div>
        <div class="takeaway-card">
            <h3>System &gt; Method</h3>
    ...
    <ol style="font-size:0.85em; text-align:left; max-width:800px; margin:0 auto;">
        <li><strong>Default choice:</strong> ODEPE (polish) for best speed-accuracy trade-off.</li>
        ...
        <li><strong>Hard systems need special attention:</strong> Consider ensemble approaches.</li>
    </ol>
    """)
...
<title>Parameter Estimation Benchmark &mdash; Independent Analysis</title>
{style_block}
