...
% PATHS RELATED DATA
%======================
inputs.pathd.results_folder='vanderpolmodel'; % Folder to keep results
inputs.pathd.short_name='vanderpol';                 % To identify figures and reports
%======================
% MODEL RELATED DATA
%======================
clear
...
inputs.exps.t_con{1}=[-1.0, 1.0];                 % Input swithching times including:
inputs.exps.n_s{1}=1001;
