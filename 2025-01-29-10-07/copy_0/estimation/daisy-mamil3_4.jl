...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-29-10-07/copy_0/data/daisy-mamil3_4.csv", Tuple, header=false))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-29-10-07/copy_0/estimation_results/daisy-mamil3_4.csv", table, header=string.(collect(keys(table))))
