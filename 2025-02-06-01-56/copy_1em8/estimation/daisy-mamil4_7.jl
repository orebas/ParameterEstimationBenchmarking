...
ic = [0.367, 0.839, 0.79, 0.139]
p_true = [0.421, 0.299, 0.505, 0.348, 0.398, 0.52, 0.7]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em8/data/daisy-mamil4_7.csv", Tuple, header=false))
...
CSV.write("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em8/estimation_results/daisy-mamil4_7.csv", table, header=string.(collect(keys(table))))
