...
- **AMIGO2** achieves the highest overall success rate at **78.5%** (success@10%).
- **ODEPE (polish)** follows at **68.3%**.
- Polishing provides a **+7.7 pp** uplift over the unpolished ODEPE variant.
- **SciML** has the lowest success rate at **39.5%**.
- Success degrades from **73.6%** at noise=0 to **34.5%** at noise=0.01 (averaged across methods).
- **47** rows produced no result; **6** rows diverged (max_rel_error > 10^4).
...
|--------|-----------|------------|------------|-----------------|-----------|----------|
| ODEPE (polish) | 57.9% | 68.3% | 74.5% | 2717 | 4 | 1 |
| ODEPE (no polish) | 47.7% | 60.5% | 68.3% | 2327 | 11 | 5 |
| AMIGO2 | 70.1% | 78.5% | 82.5% | 601 | 8 | 0 |
| SciML | 35.3% | 39.5% | 41.2% | 221 | 24 | 0 |
...
- Overall polishing uplift: **+7.7 percentage points**.
- Polishing adds a median of **390 seconds** overhead.
- Of 115 (system, noise) pairs: polishing **helped** in 28, **hurt** in 0, and was **neutral** in 87.
...
- **Hardest system:** `crauste` (14.4% mean success)
...
1. **AMIGO2** -- 78.5% success@10%, median 601s
2. **ODEPE (polish)** -- 68.3% success@10%, median 2717s
3. **ODEPE (no polish)** -- 60.5% success@10%, median 2327s
4. **SciML** -- 39.5% success@10%, median 221s

### Key Takeaways
- **Noise is the primary difficulty driver** -- success drops by ~39 pp from noise=0 to noise=0.01.
- **Polishing is almost always worthwhile** -- it helps in 28/115 cases with modest time overhead.
