...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_0/data/seir_0.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_0/estimation_results/seir_0.csv", table, header=string.(collect(keys(table))))
