#!/usr/bin/env python3
"""
Generate a self-contained reveal.js HTML presentation from the numbat benchmark analysis.
...
def build_presentation():
    ...
    <h2 style="font-size:1.2em; color:#7f8c8d;">Numbat Benchmark (Complete)</h2>
    <p style="font-size:0.8em; color:#95a5a6;">benchmark_numbat_2026-05-06</p>
    ...
    <div class="columns">
        ...
        <div class="col" style="flex:2;">
            ...
            <h3>Data Note</h3>
            <p class="footnote">All 10 replicas analyzed across all 23 systems.</p>
        </div>
    </div>
    """)
    ...
    <p class="footnote">Note: Based on 10 replicas per (system, noise, method) tuple.</p>
    """)
    ...
    <p style="color:#7f8c8d; font-size:0.8em;">
        ...
        5 noise levels &bull; 10 replicas
    </p>
    <hr style="width:40%; border-color:#3498db;">
