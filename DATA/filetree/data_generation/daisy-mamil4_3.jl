...
model, mq = create_ordered_ode_system("daisy-mamil4", states, parameters, equations, measured_quantities)
...
write(joinpath(@__DIR__, "../data_original/daisy-mamil4_3.csv"), dat_str)
