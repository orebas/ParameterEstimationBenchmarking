...
ic = [0.824, 0.337, 0.894, 0.3]
p_true = [0.84, 0.137, 0.286, 0.379, 0.752, 0.888, 0.875]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em2/data/daisy-mamil4_2.csv", Tuple, header=false))
...
CSV.write("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em2/estimation_results/daisy-mamil4_2.csv", table, header=string.(collect(keys(table))))
