...
ic = [0.508, 0.529, 0.645]
p_true = [0.562, 0.868, 0.616, 0.128, 0.444]
time_interval = [-1.0, 1.0]
datasize = 1001

sampling_times = range(time_interval[1], time_interval[2], length = datasize)

data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-28-22-18/copy_1em4/data/daisy-mamil3_1.csv", Tuple, header=false))
...
# optprob = Optimization.OptimizationProblem(optf, p_rand, lb = -3.0*ones(3+5), ub = 3.0*ones(3+5))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-28-22-18/copy_1em4/estimation_results/daisy-mamil3_1.csv", table, header=string.(collect(keys(table))))
