...
ic = [0.836, 0.671, 0.899, 0.22]
p_true = [0.817, 0.394, 0.449, 0.814, 0.745, 0.663, 0.18]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_1em4/data/daisy-mamil4_2.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_1em4/estimation_results/daisy-mamil4_2.csv", table, header=string.(collect(keys(table))))
