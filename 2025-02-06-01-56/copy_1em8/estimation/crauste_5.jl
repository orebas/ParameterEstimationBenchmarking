...
ic = [0.844, 0.636, 0.728, 0.325, 0.569]
p_true = [0.384, 0.852, 0.712, 0.699, 0.823, 0.167, 0.542, 0.568, 0.87, 0.334, 0.293, 0.18, 0.113]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em8/data/crauste_5.csv", Tuple, header=false))
...
CSV.write("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em8/estimation_results/crauste_5.csv", table, header=string.(collect(keys(table))))
