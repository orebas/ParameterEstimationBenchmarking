...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-19-37/copy_1em2/data/daisy-mamil3_0.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-19-37/copy_1em2/estimation_results/daisy-mamil3_0.csv", table, header=string.(collect(keys(table))))
