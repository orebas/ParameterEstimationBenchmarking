...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-05-09-22-01/copy_1em8/data/harmonic_0.csv", Tuple, header=false))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-05-09-22-01/copy_1em8/estimation_results/harmonic_0.csv", table, header=string.(collect(keys(table))))
