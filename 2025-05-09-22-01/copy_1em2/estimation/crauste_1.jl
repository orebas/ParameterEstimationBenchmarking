...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-05-09-22-01/copy_1em2/data/crauste_1.csv", Tuple, header=false))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-05-09-22-01/copy_1em2/estimation_results/crauste_1.csv", table, header=string.(collect(keys(table))))
