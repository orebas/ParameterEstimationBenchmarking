...
ic = [0.216, 0.49, 0.384, 0.852]
p_true = [0.417, 0.552, 0.247]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_1em8/data/seir_1.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-20-27/copy_1em8/estimation_results/seir_1.csv", table, header=string.(collect(keys(table))))
