...
ic = [0.585, 0.193, 0.682, 0.61]
p_true = [0.787, 0.742, 0.227]
...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em6/data/seir_1.csv", Tuple, header=false))
...
CSV.write("/home/orebas/julia/no-matlab-no-worry/2025-02-06-01-56/copy_1em6/estimation_results/seir_1.csv", table, header=string.(collect(keys(table))))
