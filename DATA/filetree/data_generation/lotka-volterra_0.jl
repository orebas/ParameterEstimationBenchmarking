...
model, mq = create_ordered_ode_system("lotka-volterra", states, parameters, equations, measured_quantities)
...
write(joinpath(@__DIR__, "../data_original/lotka-volterra_0.csv"), dat_str)
