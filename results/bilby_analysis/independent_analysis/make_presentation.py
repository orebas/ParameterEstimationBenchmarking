#!/usr/bin/env python3
"""
Generate a self-contained reveal.js HTML presentation from the bilby benchmark analysis.
All images are embedded as base64 -- the output is a single portable HTML file.
Rankings and conclusions are data-driven.

Usage:
    python3 results/bilby_analysis/independent_analysis/make_presentation.py
"""
...
def build_presentation():
    ...
    <h2 style="font-size:1.2em; color:#7f8c8d;">Bilby Benchmark (Complete)</h2>
    <p style="font-size:0.8em; color:#95a5a6;">benchmark_bilby_2026_03_09</p>
    ...
    <div class="columns">
        <div class="col">
            ...
            <ul>
                ...
                <li><strong>8</strong> replicas per instance</li>
    ...
    <div class="columns">
        ...
        <div class="col" style="flex:2;">
            ...
            <h3>Data Note</h3>
            <p class="footnote">All 8 replicas analyzed across all 23 systems.</p>
        </div>
    </div>
    """)
    ...
    <div class="takeaway-grid">
        ...
        <div class="takeaway-card">
            <h3>Full Dataset</h3>
            <p>All 8 replicas analyzed.</p>
        </div>
    </div>
    """)

    best_balance_m = "odepe_polish"
    vslide(f"""
...
<title>Parameter Estimation Benchmark &mdash; Bilby Analysis (Complete)</title>
{style_block}
