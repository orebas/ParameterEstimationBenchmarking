...
data_sample = Dict(vcat("t", map(x -> x.rhs, measured_quantities)) .=> CSV.read("/home/ademin/no-matlab-no-worry/2025-01-27-03-53/copy_1em8/data/biohydrogenation_0.csv", Tuple))
...
CSV.write("/home/ademin/no-matlab-no-worry/2025-01-27-03-53/copy_1em8/estimation_results/biohydrogenation_0.csv", table, header=string.(collect(keys(table))))
